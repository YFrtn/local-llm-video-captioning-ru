...
2. Нажмите **Выбрать видео** и выберите видеофайл
3. Нажмите **Play** на видеоплеере
4. Описания кадров на русском языке появятся в панели справа в реальном времени
5. Нажмите **Скачать MD** или **Скачать PDF** чтобы сохранить результат

## Экспорт результатов

После описания кадров в панели транскрипции появляются кнопки:

- **Скачать MD** — сохраняет описания в Markdown-файл
- **Скачать PDF** — сохраняет описания в PDF-документ

Каждый файл содержит: номер кадра, таймкод и описание сцены.

## История сессий

Все результаты автоматически сохраняются в браузере:

- Сессия сохраняется при паузе, окончании видео или выборе нового файла
- Кнопка **История** показывает список всех прошлых сессий
- Из истории можно открыть любую сессию, экспортировать в MD/PDF или удалить
- Хранится до 50 последних сессий в `localStorage`

## Что изменено относительно оригинала

### v1.2 — История сессий
- Автосохранение результатов при паузе/окончании видео
- Кнопка **История** для просмотра всех прошлых сессий
- Просмотр, экспорт и удаление сохранённых сессий
- Хранение до 50 сессий в localStorage браузера

### v1.1 — Экспорт в Markdown и PDF
- Кнопки **Скачать MD** и **Скачать PDF** в панели транскрипции
- PDF с поддержкой кириллицы (встроенный шрифт Roboto)
- Каждый файл содержит: номер кадра, таймкод и описание

### v1.0 — Русская локализация
